...
<body>
<center><h1>Order View & delete PAGE</h1>
<%

String sql="select * from order";
ResultSet rs=Dataconn.ListAll(sql);
out.println("<form method='post' action='DeleteServlet'>");
out.println("<table border='1'");
%>
<tr><th></th><th>seatnumber</th><th>ordernumber</th><th>Quantity</th><th>cardnumber</th></tr>
<% 
while(rs.next())
{
	//String mypath="images/"+rs.getString(10);
	out.println("<tr>");
	out.println("<td><input type='checkbox' name='user' value='"+rs.getString(1)+"' /></td>");
